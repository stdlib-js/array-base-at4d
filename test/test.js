...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof at4d, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns a nested array element (positive indices)', function test( t ) {
	...
	shape = [ 2, 2, 4, 4 ];
	x = filled4dBy( shape, discreteUniform( 0, 10 ) );
	...
	expected = flatten4d( x, shape );

	for ( i = 0; i < indices.length; i++ ) {
		actual = at4d.apply( null, [ x ].concat( indices[ i ] ) );
...
tape( 'the function returns `undefined` if provided an out-of-bounds index (positive indices)', function test( t ) {
	...
	i2 = incrspace( 0, shape[2]+10, 1 );
	i3 = incrspace( shape[3], shape[3]+10, 1 );
	indices = nCartesianProduct( i0, i1, i2, i3 );
...
tape( 'the function returns `undefined` if provided an out-of-bounds index (negative indices)', function test( t ) {
	...
	i2 = incrspace( -shape[2]-10, 0, 1 );
	i3 = incrspace( -shape[3]-10, -shape[3], 1 );
	indices = nCartesianProduct( i0, i1, i2, i3 );
